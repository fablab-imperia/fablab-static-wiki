...
extra.anteprima="profilati_alluminio_a_t.jpg"
+++
Quando capita di dover inscatolare un
...
{{
  immagine(
    url="profilati_alluminio_T_1.jpg",
    didascalia="il fissaggio dei profilati ho usato viti forma conica a coppie contrapposte e del nastro biadesivo"
  )
}}
{{
  immagine(
    url="profilati_alluminio_T_2.jpg",
    didascalia="Lo zero va fatto misurando con precizione il pezzo su tutti gli assi. Per prendere riferimenti precisi ho usato la punta di un bulino"
  )
}}
